...
<form action="/dashboard/pelanggan" method="post" class="mt-4">
    ...
    <div class="col-lg-8">
        <div class="row">
            <div class="col">
                <div class="mb-3">
                    <label for="id_gol" class="form-label">Nama Kepala Keluarga</label>
        ...
        <div class="row mt-5">
            <div class="mb-3 col-md-4">
                <label for="no" class="form-label">No Rumah</label>
        ...
        <div class="mb-3">
            <label for="nama" class="form-label">Jenis Iuran</label>
        ...
        <div class="row mt-5">
            ...
            <div class="col">
                <div class="mb-3">
                    <label for="ktp" class="form-label">No Anggota</label>
                    <input type="text" name="ktp" id="ktp" class="form-control @error('ktp') is-invalid @enderror" aria-describedby="validationKtp" value="{{ old('ktp') }}" required>
        ...
        <div class="row">
            <div class="col">
                <div class="mb-3">
                    <label for="seri" class="form-label">Jumlah Iuran</label>
                    <input type="number" min="0" name="seri" id="seri" class="form-control @error('seri') is-invalid @enderror" aria-describedby="validationSeri" value="{{ old('seri') }}" required>
            ...
            <div class="col">
                <div class="mb-3">
                    <label for="meteran" class="form-label">Bulan Pembayaran</label>
                    <input type="number" min="0" name="meteran" id="meteran" class="form-control @error('meteran') is-invalid @enderror" aria-describedby="validationMeteran" value="{{ old('meteran') }}" required>
